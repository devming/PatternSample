    ...
    var settings: [CCGestureLock.GestureLockState : (sensor: CCGestureLockSensor, line: LineAppearance)] = [
        ...
        .normal : (
            CCGestureLockSensor(
                appearance: CCGestureLockSensor.SensorAppearance(
                    defaultRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 5, width: 1, color: .darkGray),
                    maxRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 0, width: 0, color: .clear)
            ))
            ,
            LineAppearance(
                width: 5.5,
        ...
        .selected : (
            CCGestureLockSensor(appearance: CCGestureLockSensor.SensorAppearance(
                defaultRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 3, width: 5, color: .darkGray),
                maxRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 30, width: 5, color: .darkGray)
            ))
            ,
            LineAppearance(
                width: 5.5,
        ...
        .error : (
            CCGestureLockSensor(appearance: CCGestureLockSensor.SensorAppearance(
                defaultRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 3, width: 5, color: .red),
                maxRing: CCGestureLockSensor.SensorAppearance.RingAppearance(radius: 30, width: 5, color: .red)
            ))
            ,
            LineAppearance(
                width: 5.5,
